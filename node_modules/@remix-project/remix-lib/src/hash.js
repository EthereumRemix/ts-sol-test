...
const keccak = function (a, bits = 256) {
    ...
    switch (bits) {
        case 224: {
            return (0, util_1.toBuffer)((0, keccak_1.keccak224)(a));
        }
        case 256: {
            return (0, util_1.toBuffer)((0, keccak_1.keccak256)(a));
        }
        case 384: {
            return (0, util_1.toBuffer)((0, keccak_1.keccak384)(a));
        }
        case 512: {
            return (0, util_1.toBuffer)((0, keccak_1.keccak512)(a));
        }
        default: {
...
const keccakFromHexString = function (a, bits = 256) {
    ...
    return (0, exports.keccak)((0, util_1.toBuffer)(a), bits);
};
...
const _ripemd160 = function (a, padded) {
    ...
    const hash = createHash('rmd160')
        ...
        .digest();
    if (padded === true) {
        return (0, util_1.setLengthLeft)(hash, 32);
    }
    else {
        return hash;
    }
...
const rlphash = function (a) {
    return (0, exports.keccak)(Buffer.from((0, rlp_1.encode)(a)));
};
