...
export declare type getPackages = () => Promise<{
    [name: string]: string;
}>;
export declare class RemixURLResolver {
    ...
    constructor(getDependencies?: getPackages, gistToken?: string, protocol?: string);
    ...
    */
    ...
    getHandlers(): Handler[];
    resolve(filePath: string, customHandlers?: Handler[], force?: boolean): Promise<Imported>;
}
export {};
